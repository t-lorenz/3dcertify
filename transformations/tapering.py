...
class TaperingZ(Transformation):
    ...
    def gradient_points(
        ...
        return [
            iv.stack(
                [(0.5 * iv.square(a) * z + b * z + 1), zero, zero],
                axis=1,
                convert=isinstance(a, Interval),
            ),
            iv.stack(
                [zero, (0.5 * iv.square(a) * z + b * z + 1), zero],
                axis=1,
                convert=isinstance(a, Interval),
            ),
            iv.stack(
        ...
        return [
            [
                ...
                iv.stack([zero, zero, zero],
                         ...
                         convert=isinstance(a, Interval)),
                iv.stack(
                    [(0.5 * iv.square(a) + b) * one, zero, zero],
                    axis=1,
                    convert=isinstance(a, Interval),
                ),
            ],
            [
                ...
                iv.stack([zero, zero, zero],
                         ...
                         convert=isinstance(a, Interval)),
                iv.stack(
                    [zero, (0.5 * iv.square(a) + b) * one, zero],
                    axis=1,
                    convert=isinstance(a, Interval),
                ),
            ],
