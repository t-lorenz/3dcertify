...
def modelnet40(
    ...
    assert rotate in ["none", "z",
                      "so3"], "rotate must be one of 'none', 'z', 'so3'"
    train = split == "train"
    ...
    return datasets.modelnet.ModelNet(
        root=dataset_root,
        name="40",
        train=train,
...
def shapenet(num_points: int = 1024,
             split: str = "train",
             rotate: str = "z") -> datasets.shapenet.ShapeNet:
    ...
    return datasets.shapenet.ShapeNet(
        root=dataset_root,
